  ...
  return (
    <main style={{ minHeight: "100vh", background: "var(--paper)" }}>
      <nav style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "22px 48px", borderBottom: "1px solid rgba(14,12,9,0.08)" }}>
        ...
        <Link href="/legal/terms" style={{ fontFamily: "var(--font-sans)", fontSize: "11px", letterSpacing: "0.15em", textTransform: "uppercase", color: "rgba(14,12,9,0.45)", textDecoration: "none", fontWeight: 600 }}>Terms of service</Link>
      </nav>
      ...
      <footer style={{ padding: "28px 48px", borderTop: "1px solid rgba(14,12,9,0.08)", display: "flex", gap: "24px" }}>
        <Link href="/legal/terms" style={{ fontFamily: "var(--font-sans)", fontSize: "11px", letterSpacing: "0.15em", textTransform: "uppercase", color: "rgba(14,12,9,0.4)", textDecoration: "none", fontWeight: 600 }}>Terms of service</Link>
