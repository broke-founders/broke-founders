  ...
  return (
    <div style={{display:"flex",flexDirection:"column",height:"520px",border:"1px solid rgba(14,12,9,0.1)",background:"var(--paper)"}}>
      ...
      <div style={{flex:1,overflowY:"auto",padding:"20px",display:"flex",flexDirection:"column",gap:"16px"}}>
        {loading && (
          <p style={{fontFamily:"var(--font-sans)",fontSize:"12px",color:"rgba(14,12,9,0.35)",textAlign:"center"}}>Loading...</p>
        )}
        {!loading && messages.length === 0 && (
          <p style={{fontFamily:"var(--font-sans)",fontSize:"13px",color:"rgba(14,12,9,0.35)",textAlign:"center",marginTop:"40px"}}>
        ...
        {messages.map(msg => (
          <div key={msg.id} style={{display:"flex",gap:"10px",alignItems:"flex-start"}}>
            {msg.users?.avatar_url
              ...
              : <div style={{width:28,height:28,borderRadius:"50%",background:"rgba(14,12,9,0.08)",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"var(--font-sans)",fontSize:"11px",fontWeight:700,color:"rgba(14,12,9,0.5)",flexShrink:0,marginTop:2}}>{msg.users?.username?.[0]?.toUpperCase()||"?"}</div>
            }
            <div style={{flex:1}}>
              <div style={{display:"flex",alignItems:"baseline",gap:"8px",marginBottom:"4px"}}>
                ...
                <span style={{fontFamily:"var(--font-sans)",fontSize:"10px",color:"rgba(14,12,9,0.35)"}}>
      ...
      {/* Input */}
      <div style={{padding:"16px 20px",borderTop:"1px solid rgba(14,12,9,0.1)",display:"flex",gap:"8px"}}>
        <input
          value={input}
